                        ...
                        <form class="form-horizontal">
                            ...
                            <div class="control-group">
                                <div class="controls">
                                    ...
                                    &nbsp;&nbsp;&nbsp;
                                    <input class="btn btn-primary" onclick="location.href = '<c:url value="/pageAdmin/subject/addRest" />'" value="Thêm mới" type="button">
                                </div>
                            </div>
                        </form>
                    </div>
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <tr ng-repeat="std in listData">
                                    ...
                                    <td>{{std.year}}</td>
                                    <td style="width: 70px">
                                        <a href="${pageContext.request.contextPath}/pageAdmin/subject/editRest?id={{std.id}}">
                                            Sửa
                                        </a>
                                        &nbsp;&nbsp;&nbsp;
