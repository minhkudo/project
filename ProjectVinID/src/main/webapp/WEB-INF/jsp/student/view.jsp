                        ...
                        <form class="form-horizontal">
                            ...
                            <div class="control-group">
                                <div class="controls">
                                    ...
                                    &nbsp;&nbsp;&nbsp;
                                    <input class="btn btn-primary" onclick="location.href = '<c:url value="/pageAdmin/student/addRest" />'" value="Thêm mới" type="button">
                                </div>
                            </div>
                        </form>
                    </div>
...
<!--                                        <a href="${pageContext.request.contextPath}/student/edit?id={{std.id}}">
                                        ...
                                        <a href="${pageContext.request.contextPath}/pageAdmin/student/editRest?id={{std.id}}">
                                            Sửa
                                        </a>
                                        &nbsp;&nbsp;&nbsp;
