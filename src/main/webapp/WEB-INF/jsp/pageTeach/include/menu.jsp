...
<div id="user-nav" class="navbar navbar-inverse">
    <ul class="nav">
        ...
        <li class=""><a title="" href="<c:url value="/logoutTeach"/>"><i class="icon icon-share-alt"></i> <span class="text">Logout</span></a></li>
    </ul>
</div>
<!--<div id="search">
...
<div id="sidebar"> 
    ...
    <ul>
        <li class="submenu"> <a href="<c:url value="/pageTeach/index"/>"><i class="icon icon-th-list"></i> <span>Trang chủ</span> </a> </li>
        <li class="submenu"> <i class="icon icon-th-list"></i> <span>Danh Sách Sinh Viên</span> <span class="label label-important">3</span></a>
            <ul>
                <li><a href="<c:url value="/pageTeach/list/"/>">Điểm Danh</a></li>            
            </ul>
        </li>
    </ul>
</div>
